...
public class ISubPage20 extends JFrame implements ActionListener
{
    ...
    public ISubPage20()
    {
        ...
        l1.setBounds(550,50,900,200);
        p1.add(l1);
        
        l2 = new JLabel("Plot No.: 13,Sec. No.:,13 Sonargaon Janapath,Dhaka");
        l2.setFont(new Font("Comic Sans MS",Font.BOLD,50));
        l2.setForeground(Color.YELLOW);
        l2.setBounds(120,200,1500,200);
        p1.add(l2);
        ...
        l4 = new JLabel("Category : Fast food & Pizza");
        l4.setFont(new Font("Comic Sans MS",Font.BOLD,50));
        l4.setForeground(Color.YELLOW);
        l4.setBounds(400,500,900,200);
        p1.add(l4);

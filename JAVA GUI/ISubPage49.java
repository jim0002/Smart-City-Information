...
public class ISubPage49 extends JFrame implements ActionListener
{
    JLabel l1,l2,l3,l4;
    JButton b11,b12;
    JPanel p1;
    ...
    public ISubPage49()
    {
        super("Export Import Bank Of Bangladesh Limited");
        ...
        l1 = new JLabel("Export Import Bank Of Bangladesh Limited");
        l1.setFont(new Font("Comic Sans MS",Font.BOLD,50));
        l1.setForeground(Color.YELLOW);
        l1.setBounds(300,50,1200,200);
        p1.add(l1);
        
        l2 = new JLabel("Location : Symphony,Gulshan Avenue,Dhaka");
        l2.setFont(new Font("Comic Sans MS",Font.BOLD,50));
        l2.setForeground(Color.YELLOW);
        l2.setBounds(250,200,1500,200);
        p1.add(l2);
        
        l3 = new JLabel("Rating : 9.5/10");
        l3.setFont(new Font("Comic Sans MS",Font.BOLD,50));
        l3.setForeground(Color.YELLOW);
        l3.setBounds(480,400,900,200);
        p1.add(l3);
        
        l4 = new JLabel("Online Service : Yes");

...
public class ISubPage8 extends JFrame implements ActionListener
{
    JLabel l1,l2,l3,l4;
    JButton b11,b12;
    JPanel p1;
    ...
    public ISubPage8()
    {
        super("UTTARA HIGH SCHOOL & COLLEGE ");
        ...
        l1 = new JLabel("UTTARA HIGH SCHOOL & COLLEGE ");
        l1.setFont(new Font("Comic Sans MS",Font.BOLD,50));
        l1.setForeground(Color.YELLOW);
        l1.setBounds(430,50,1200,200);
        p1.add(l1);
        
        l2 = new JLabel("Location : Uttara, Dhaka");
        l2.setFont(new Font("Comic Sans MS",Font.BOLD,50));
        l2.setForeground(Color.YELLOW);
        l2.setBounds(350,200,900,200);
        p1.add(l2);
        
        l3 = new JLabel("Rank in 2020: No Rank");

...
public class Page20 extends JFrame implements ActionListener
{
	...
	public Page20()
	{
		...
		b4 = new JButton("Cha Time Bangladesh");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			ISubPage16 p1 = new ISubPage16();
			this.setVisible(false);
			p1.setVisible(true);
		}
			else if(ae.getSource()==b2)
		{
			ISubPage17 p1 = new ISubPage17();
			this.setVisible(false);
			p1.setVisible(true);
		}
			else if(ae.getSource()==b3)
		{
			ISubPage18 p1 = new ISubPage18();
			this.setVisible(false);
			p1.setVisible(true);
		}	else if(ae.getSource()==b4)
		{
			ISubPage19 p1 = new ISubPage19();
			this.setVisible(false);
			p1.setVisible(true);
		}
			else if(ae.getSource()==b5)
		{
			ISubPage20 p1 = new ISubPage20();
			this.setVisible(false);
			p1.setVisible(true);
		}
	}

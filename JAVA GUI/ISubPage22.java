...
public class ISubPage22 extends JFrame implements ActionListener
{
    JLabel l1,l2,l3,l4;
    JButton b11,b12;
    JPanel p1;
    ...
    public ISubPage22()
    {
        super("Best Western Plus Maple Leaf");
        ...
        l1 = new JLabel("Best Western Plus Maple Leaf");
        l1.setFont(new Font("Comic Sans MS",Font.BOLD,50));
        l1.setForeground(Color.YELLOW);
        l1.setBounds(450,50,900,200);
        p1.add(l1);
        
        l2 = new JLabel("Location : Plot 1B, Rd No 1, Dhaka 1230");

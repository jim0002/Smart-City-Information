...
public class ISubPage50 extends JFrame implements ActionListener
{
    JLabel l1,l2,l3,l4;
    JButton b11,b12;
    JPanel p1;
    ...
    public ISubPage50()
    {
        ...
        l1 = new JLabel("Dhaka Bank Limited");
        l1.setFont(new Font("Comic Sans MS",Font.BOLD,50));
        l1.setForeground(Color.YELLOW);
        l1.setBounds(450,50,900,200);
        p1.add(l1);
        
        l2 = new JLabel("Location: House 964/1,Block - B Sahid Baki Road,Dhaka");
        l2.setFont(new Font("Comic Sans MS",Font.BOLD,50));
        l2.setForeground(Color.YELLOW);
        l2.setBounds(60,200,1600,200);
        p1.add(l2);
        
        l3 = new JLabel("Rating : 8.0/10");

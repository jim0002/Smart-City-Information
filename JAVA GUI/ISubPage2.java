...
public class ISubPage2 extends JFrame implements ActionListener
{
    JLabel l1,l2,l3,l4;
    JButton b11,b12;
    JPanel p1;
    ...
    public ISubPage2()
    {
        ...
        l1 = new JLabel("Lalbagh Fort");
        l1.setFont(new Font("Comic Sans MS",Font.BOLD,50));
        l1.setForeground(Color.YELLOW);
        l1.setBounds(500,50,900,200);
        p1.add(l1);
        
        l2 = new JLabel("Location : Azimpur, Dhaka");

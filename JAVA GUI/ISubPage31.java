...
public class ISubPage31 extends JFrame implements ActionListener
{
    JLabel l1,l2,l3,l4;
    JButton b11,b12;
    JPanel p1;
    ...
    public ISubPage31()
    {
        super("Bashundhara City Shopping Complex");
        ...
        l1 = new JLabel("Bashundhara City Shopping Complex");
        l1.setFont(new Font("Comic Sans MS",Font.BOLD,50));
        l1.setForeground(Color.YELLOW);
        l1.setBounds(450,50,900,200);
        p1.add(l1);
        
        l2 = new JLabel("Location: 3 No Tejturi Bazar West,Panthapath,Dhaka");

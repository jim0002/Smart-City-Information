...
public class ISubPage44 extends JFrame implements ActionListener
{
    JLabel l1,l2,l3,l4;
    JButton b11,b12;
    JPanel p1;
    ...
    public ISubPage44()
    {
        super("Dhaka Community Medical College and Hospital");
        ...
        l1 = new JLabel("Dhaka Community Medical College and Hospital");
        l1.setFont(new Font("Comic Sans MS",Font.BOLD,50));
        l1.setForeground(Color.YELLOW);
        l1.setBounds(250,50,1500,200);
        p1.add(l1);
        
        l2 = new JLabel("Location: Wireless Railgate Bara Moghbazar,Dhaka");
        l2.setFont(new Font("Comic Sans MS",Font.BOLD,50));
        l2.setForeground(Color.YELLOW);
        l2.setBounds(150,200,1600,200);
        p1.add(l2);

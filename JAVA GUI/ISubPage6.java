...
public class ISubPage6 extends JFrame implements ActionListener
{
    JLabel l1,l2,l3,l4;
    JButton b11,b12;
    JPanel p1;
    ...
    public ISubPage6()
    {
        super("RAJUCK UTTARA MODEL COLLEGE");
        ...
        l1 = new JLabel("RAJUCK UTTARA MODEL COLLEGE");

...
public class ISubPage39 extends JFrame implements ActionListener
{
    JLabel l1,l2,l3,l4;
    JButton b11,b12;
    JPanel p1;
    ...
    public ISubPage39()
    {
        super("Shaheed Suhrawardi Indoor Stadium");
        ...
        l1 = new JLabel("Shaheed Suhrawardi Indoor Stadium");
        l1.setFont(new Font("Comic Sans MS",Font.BOLD,50));
        l1.setForeground(Color.YELLOW);
        l1.setBounds(280,50,1200,200);
        p1.add(l1);
        
        l2 = new JLabel("Location: Mirpur 10 Roundabout,Dhaka");
        l2.setFont(new Font("Comic Sans MS",Font.BOLD,50));
        l2.setForeground(Color.YELLOW);
        l2.setBounds(250,200,1200,200);
        p1.add(l2);
        
        l3 = new JLabel("Rating : 9.0/10");
        l3.setFont(new Font("Comic Sans MS",Font.BOLD,50));
        l3.setForeground(Color.YELLOW);
        l3.setBounds(480,400,900,200);
        p1.add(l3);
        
        l4 = new JLabel("Type : Indoor");

...
public class ISubPage9 extends JFrame implements ActionListener
{
    JLabel l1,l2,l3,l4;
    JButton b11,b12;
    JPanel p1;
    ...
    public ISubPage9()
    {
        super("SAINT JOSEPH HIGHER SEC. COLLEGE");
        ...
        l1 = new JLabel("SAINT JOSEPH HIGHER SEC. COLLEGE");
        l1.setFont(new Font("Comic Sans MS",Font.BOLD,50));
        l1.setForeground(Color.YELLOW);
        l1.setBounds(220,50,1200,200);
        p1.add(l1);
        
        l2 = new JLabel("Location : Mohammadpur, Dhaka");
        ...
        l4 = new JLabel("Student type: Both ");

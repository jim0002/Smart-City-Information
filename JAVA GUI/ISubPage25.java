...
public class ISubPage25 extends JFrame implements ActionListener
{
    JLabel l1,l2,l3,l4;
    JButton b11,b12;
    JPanel p1;
    ...
    public ISubPage25()
    {
        ...
        l1 = new JLabel("Hotel Amirs");
        l1.setFont(new Font("Comic Sans MS",Font.BOLD,50));
        l1.setForeground(Color.YELLOW);
        l1.setBounds(450,50,900,200);
        p1.add(l1);
        
        l2 = new JLabel("Location : Taher Plaza, Shahid Latif Road Near Kosai Badi Rail Gate, Dhaka 1230");

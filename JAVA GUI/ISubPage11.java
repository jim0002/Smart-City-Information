...
public class ISubPage11 extends JFrame implements ActionListener
{
    JLabel l1,l2,l3,l4;
    JButton b11,b12;
    JPanel p1;
    ...
    public ISubPage11()
    {
        super("American International University-Bangladesh");
        ...
        l1.setBounds(200,50,1300,200);
        p1.add(l1);
        
        l2 = new JLabel("Location : Kuril, Dhaka");

...
public class ISubPage34 extends JFrame implements ActionListener
{
    JLabel l1,l2,l3,l4;
    JButton b11,b12;
    JPanel p1;
    ...
    public ISubPage34()
    {
        super("Shyamoli Square Shopping Mal");
        ...
        l1 = new JLabel("Shyamoli Square Shopping Mal");
        l1.setFont(new Font("Comic Sans MS",Font.BOLD,50));
        l1.setForeground(Color.YELLOW);
        l1.setBounds(450,50,900,200);
        p1.add(l1);
        
        l2 = new JLabel("Location : Shyamoli Square shopping Mall,Dhaka");

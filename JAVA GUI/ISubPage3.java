...
public class ISubPage3 extends JFrame implements ActionListener
{
    JLabel l1,l2,l3,l4;
    JButton b11,b12;
    JPanel p1;
    ...
    public ISubPage3()
    {
        super("National Parliament House");
        ...
        l1 = new JLabel("National Parliament House");
        l1.setFont(new Font("Comic Sans MS",Font.BOLD,50));
        l1.setForeground(Color.YELLOW);
        l1.setBounds(400,50,900,200);
        p1.add(l1);
        
        l2 = new JLabel("Location : Bijoy-shoroni, Dhaka");
        ...
        l4 = new JLabel("Entry Fee :  No Cost");
